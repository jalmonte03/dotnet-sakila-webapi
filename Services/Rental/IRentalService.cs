...
public interface IRentalService
{
    ...
    public Task<RentalsGetDTO> GetRentals(int Page, int Limit, int? CustomerId, int? FilmId);
    public Task<IEnumerable<RentalMonthSummaryDTO>> GetMonthlyRentalsSummary(DateOnly From, DateOnly To);
    public Task<IEnumerable<RentalMonthRevenueDTO>> GetMonthlyRentalRevenue(DateOnly From, DateOnly To);
}